    ...
    <div className="mx-auto max-w-3xl space-y-6 p-6">
      ...
      <GarageSettingsForm
        initial={{
          ...
          iban: garage.iban,
          isVatPayer: garage.isVatPayer,
          // Decimal nejde poslat přes server/client hranici přímo -
          // převod na number, stejně jako u JobItem cen.
          defaultVatRate: garage.defaultVatRate ? Number(garage.defaultVatRate) : null,
          invoicePrefix: garage.invoicePrefix,
          invoiceDueDays: garage.invoiceDueDays,
          nextInvoiceNumber: garage.nextInvoiceNumber,
        }}
      />
    </div>
  );
