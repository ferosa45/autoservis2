...
export function JobDetailPanel({ job, showFinancials, canInvoice, canViewInvoices }: { job: Job; showFinancials: boolean; canInvoice: boolean; canViewInvoices: boolean }) {
