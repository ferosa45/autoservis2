  ...
  return (
    <main className="min-h-screen bg-background text-text-primary">
      <header className="border-b border-border bg-surface">
        <div className="mx-auto flex max-w-5xl items-center gap-3 px-5 py-5 lg:px-8">
          <Link href="/admin" className="rounded-lg p-2 text-text-muted hover:bg-surface-hover hover:text-text-primary">
            <ArrowLeft className="h-5 w-5" />
          </Link>
          <div>
            <p className="text-xs font-semibold text-text-muted">Garazio Admin / Servisy</p>
            <h1 className="font-heading text-xl font-extrabold">{garage.name}</h1>
          </div>
        </div>
      </header>
        ...
        <div className="grid gap-4 lg:grid-cols-[1.3fr_0.7fr]">
          <section className="rounded-xl border border-border bg-surface p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                <p className="text-xs font-bold uppercase tracking-widest text-primary">Účet</p>
                <h2 className="mt-2 font-heading text-2xl font-extrabold">{garage.name}</h2>
                {garage.companyName && <p className="mt-1 text-sm text-text-secondary">{garage.companyName}</p>}
              </div>
